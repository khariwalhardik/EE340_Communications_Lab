...
class task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_0_0, 2))
        ...
        self.connect((self.blocks_divide_xx_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.blocks_divide_xx_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_time_sink_x_0_0, 1))
