...
class task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_tab_widget_widget_6 = Qt.QWidget()
        self.qtgui_tab_widget_layout_6 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.qtgui_tab_widget_widget_6)
        self.qtgui_tab_widget_grid_layout_6 = Qt.QGridLayout()
        self.qtgui_tab_widget_layout_6.addLayout(self.qtgui_tab_widget_grid_layout_6)
        self.qtgui_tab_widget.addTab(self.qtgui_tab_widget_widget_6, 'moving_average_output')
        ...
        self.qtgui_tab_widget_layout_6.addWidget(self._qtgui_sink_x_1_win)
        ...
        self.qtgui_tab_widget_layout_3.addWidget(self._qtgui_sink_x_0_1_0_0_win)
        ...
        self.qtgui_tab_widget_layout_4.addWidget(self._qtgui_sink_x_0_1_0_win)
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff((-0.0002), 0.0002, 0)
        self.blocks_skiphead_0_0_1 = blocks.skiphead(gr.sizeof_char*1, 7)
        ...
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_char*1, 'output_1.txt', False)
        self.blocks_file_sink_0_0_1.set_unbuffered(False)
        self.blocks_conjugate_cc_0 = blocks.conjugate_cc()
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_abs_xx_0 = blocks.abs_ff(1)
        self.analog_sig_source_x_0_1 = analog.sig_source_c(8000000, analog.GR_COS_WAVE, (500000 + f_off), 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(8000000, analog.GR_COS_WAVE, 500000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_conjugate_cc_0, 0))
        ...
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_skiphead_0_0_1, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.qtgui_sink_x_1, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0_0_1, 0), (self.blocks_file_sink_0_0_1, 0))
        self.connect((self.blocks_skiphead_0_0_1, 0), (self.blocks_pack_k_bits_bb_0_0_1, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.qtgui_sink_x_0_1_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.qtgui_sink_x_0_1_0_0, 0))
