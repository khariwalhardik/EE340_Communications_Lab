...
class Pre_DeEmphasis(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Task3", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pre_DeEmphasis")
...
def main(top_block_cls=Pre_DeEmphasis, options=None):
