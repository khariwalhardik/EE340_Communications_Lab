...
class TASK1_abcd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_sink_x_1_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_sink_x_1_0, 0))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.blocks_add_xx_1, 0))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.qtgui_sink_x_1, 0))
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(0, (self.symbol_rate*8))
        self.qtgui_sink_x_1.set_frequency_range(0, (self.symbol_rate*8*5))
        self.qtgui_sink_x_1_0.set_frequency_range(0, (self.symbol_rate*8*5))
        self.qtgui_sink_x_1_0_0.set_frequency_range(0, (self.symbol_rate*8*5))
