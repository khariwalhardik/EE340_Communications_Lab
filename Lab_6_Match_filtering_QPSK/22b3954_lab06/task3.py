...
class task3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._skip_range = qtgui.Range(0, 7, 1, 3, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'task3.txt', False)
        ...
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_or_xx_0, 0))
        self.connect((self.blocks_float_to_uchar_0_0, 0), (self.blocks_or_xx_0, 1))
        ...
        self.connect((self.blocks_or_xx_0, 0), (self.blocks_skiphead_0, 0))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_threshold_ff_0_0, 0))
    ...
    def set_alpha(self, alpha):
        ...
        self.root_raised_cosine_filter_0_1.set_taps(firdes.root_raised_cosine(3, 80000, 10000, self.alpha, 88))
