...
class pulse_shape(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pulse_shape")
        ...
        self.top_layout.addWidget(self._qtgui_time_sink_x_0_0_1_0_0_1_1_win)
        ...
        self.blocks_skiphead_0_0_1 = blocks.skiphead(gr.sizeof_char*1, 4)
        ...
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_char*1, 'matched.txt', False)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(400000, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.qtgui_freq_sink_x_2, 0))
...
def main(top_block_cls=pulse_shape, options=None):
