...
class EE340_LAB2_task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "EE340_LAB2_task2")
        ...
        # Variables
        ##################################################
        self.samp_rate1 = samp_rate1 = 32000
        ...
        self.time.addTab(self.time_widget_0, 'Message')
        ...
        self.time_layout_1.addWidget(self._qtgui_time_sink_x_2_win)
        ...
        self.time_layout_2.addWidget(self._qtgui_time_sink_x_1_win)
        ...
        self.freq_layout_0.addWidget(self._qtgui_freq_sink_x_2_win)
        ...
        self.freq_layout_1.addWidget(self._qtgui_freq_sink_x_1_win)
        ...
        self.freq_layout_2.addWidget(self._qtgui_freq_sink_x_0_win)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_throttle_2, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_2, 0))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_throttle_2, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_wavfile_source_1, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.blocks_wavfile_source_1, 0), (self.blocks_throttle_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 130000, 100, window.WIN_KAISER, 6.76))
...
def main(top_block_cls=EE340_LAB2_task2, options=None):
