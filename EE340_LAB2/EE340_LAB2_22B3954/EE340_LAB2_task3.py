...
class EE340_LAB2_task3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "EE340_LAB2_task3")
        ...
        self.time.addTab(self.time_widget_0, 'modulated')
        ...
        self.freq.addTab(self.freq_widget_0, 'modulated')
        ...
        self.blocks_wavfile_source_1 = blocks.wavfile_source('background.wav', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('vocal.wav', True)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'data.dat', False)
        ...
        self.connect((self.blocks_wavfile_source_1, 0), (self.blocks_multiply_xx_0_0, 1))
...
def main(top_block_cls=EE340_LAB2_task3, options=None):
